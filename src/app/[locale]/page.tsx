  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-4 bg-[#FAF7F2] text-[#2C2416]">
          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight text-balance font-serif">
                  Осветите Ваше
                  <span className="block text-[#C17B5C] mt-2">Идеальное пространство</span>
                </h1>

                <p className="text-lg md:text-xl text-[#6B5D4F] mb-8 leading-relaxed max-w-xl text-pretty font-sans">
                ...
                >
                  <motion.div variants={itemVariants}>
                    <Link
                      href="/catalog"
                      className="group inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-[#FAF7F2] bg-[#C17B5C] hover:bg-[#A66A4D] transition-all duration-300 rounded-full shadow-lg hover:shadow-xl font-sans"
                    >
                  ...
                  <motion.div variants={itemVariants}>
                    <Link
                      href="/contact"
                      className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-[#2C2416] bg-transparent border-2 border-[#E8DCC8] hover:bg-[#E8DCC8]/50 transition-all duration-300 rounded-full font-sans"
                    >
                ...
                {/* Статистика */}
                <motion.div
                  className="grid grid-cols-3 gap-6 mt-12 pt-12 border-t border-[#E8DCC8]"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8, delay: 0.4 }}
                >
                  <div>
                    <div className="text-3xl font-bold text-[#C17B5C] mb-1 font-serif">500+</div>
                    <div className="text-sm text-[#6B5D4F] font-sans">Уникальных дизайнов</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-[#C17B5C] mb-1 font-serif">15K+</div>
                    <div className="text-sm text-[#6B5D4F] font-sans">Счастливых клиентов</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-[#C17B5C] mb-1 font-serif">4.9★</div>
                    <div className="text-sm text-[#6B5D4F] font-sans">Средний рейтинг</div>
                  </div>
                </motion.div>
              </motion.div>
              ...
              >
                <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
                  <img
                    src="/uploads/modern-elegant-pendant-light-in-cozy-living-room-w.jpg"
                ...
                <motion.div
                  className="absolute -bottom-6 -left-6 bg-white border-2 border-[#E8DCC8] rounded-2xl p-6 shadow-xl"
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.6, delay: 0.8 }}
                >
                  <div className="flex items-center gap-4">
                    <div className="p-3 bg-[#C17B5C]/10 rounded-xl">
                      <Lightbulb className="w-8 h-8 text-[#C17B5C]" />
                    </div>
                    <div>
                      <div className="text-sm text-[#6B5D4F] font-sans">Энергоэффективность</div>
                      <div className="text-lg font-bold font-serif">LED Технологии</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
        ...
        <section className="py-24 bg-[#E8DCC8]/30">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-4 text-balance font-serif">Исследуйте наши коллекции</h2>
              <p className="text-lg text-[#6B5D4F] max-w-2xl mx-auto text-pretty font-sans">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
              {categories.map((category, i) => {
                ...
                return (
                  <motion.div
                    key={i}
                    className="group relative bg-white border border-[#E8DCC8] p-8 transition-all duration-500 hover:shadow-xl hover:-translate-y-2 rounded-2xl cursor-pointer"
                    initial="hidden"
                    whileInView="visible"
                    variants={containerVariants}
                    viewport={{ once: true }}
                  ...
                  >
                    <div className="relative z-10">
                      <div className="inline-flex items-center justify-center w-16 h-16 bg-[#C17B5C]/10 mb-6 group-hover:bg-[#C17B5C]/20 transition-colors duration-300 rounded-xl">
                        <Icon className="w-8 h-8 text-[#C17B5C]" />
                      </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              <motion.div
                ...
                variants={containerVariants}
                viewport={{ once: true }}
                className="group relative bg-[#E8DCC8]/30 border border-[#E8DCC8] p-10 transition-all duration-500 hover:shadow-xl rounded-3xl"
              >
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-8">
                    <div className="p-3 bg-[#C17B5C] rounded-xl">
                      <Star className="w-7 h-7 text-[#FAF7F2]" />
                    </div>
              ...
              <motion.div
                ...
                variants={containerVariants}
                viewport={{ once: true }}
                className="group relative bg-[#C17B5C]/5 border border-[#C17B5C]/20 p-10 transition-all duration-500 hover:shadow-xl rounded-3xl"
              >
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-8">
                    <div className="p-3 bg-[#C17B5C] rounded-xl">
                      <Sparkles className="w-7 h-7 text-[#FAF7F2]" />
                    </div>
        ...
        <section className="py-24 bg-[#E8DCC8]/30">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-4 text-balance font-serif">Простой процесс покупки</h2>
              <div className="w-24 h-1 bg-[#C17B5C] mx-auto rounded-full mt-6"></div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-7xl mx-auto">
              {steps.map((step, i) => {
                ...
                return (
                  <motion.div
                    key={i}
                    className="group relative bg-white border border-[#E8DCC8] p-8 transition-all duration-500 text-center hover:shadow-xl hover:-translate-y-2 rounded-2xl"
                    initial="hidden"
                    whileInView="visible"
                    variants={containerVariants}
                    viewport={{ once: true }}
                  ...
                  >
                    <div className="relative z-10">
                      <div className="inline-flex items-center justify-center w-16 h-16 bg-[#C17B5C]/10 mb-4 group-hover:bg-[#C17B5C]/20 transition-all duration-300 rounded-xl">
                        <Icon className="w-8 h-8 text-[#C17B5C]" />
                      </div>
        ...
        <section className="py-24 bg-[#FAF7F2]">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-4 text-balance font-serif">Популярные светильники</h2>
              <p className="text-lg text-[#6B5D4F] max-w-2xl mx-auto text-pretty font-sans">
        ...
        {/* CTA */}
        <section className="py-24 bg-[#C17B5C] text-[#FAF7F2] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <motion.h2
              className="text-4xl md:text-6xl font-bold mb-6 text-balance font-serif"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
            ...
            <motion.p
              className="text-lg md:text-xl mb-12 max-w-3xl mx-auto leading-relaxed text-[#FAF7F2]/90 text-pretty font-sans"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              <Link
                href="/catalog"
                className="inline-flex items-center justify-center px-12 py-4 text-lg font-semibold text-[#C17B5C] bg-[#FAF7F2] hover:bg-[#FAF7F2]/90 transition-all duration-300 rounded-full shadow-2xl hover:shadow-3xl font-sans"
              >
